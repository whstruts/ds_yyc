...
public interface SpzlMapper {
	...
	@Select("select * from (select a.ddwname as Suppliers_name,b.prvno as ypdm,b.dspcd as cddm,c.jxmc as jx,isnull(d.scrq,'') as scrq," +
			"                      a.dspid+'#'+isnull(d.picih,'') as Goods_id_s,b.dspcode as Goods_sn,b.dspname as Drug_common_name,b.shenccj as manufacturer,c.pzwh as Approve_number,a.picurl as Drug_img,b.dspspgg as specifications," +
			...
			"                      b.sptm as Bar_code,e.hsj as Supplier_price,a.is_zais as Is_on_sale,c.G_YPJYFW as Category,a.is_gengx from doc_sp_wz a" +
			"                                                                                                                                      left join doc_sp b on a.dspid=b.dspid" +
			"                                                                                                                                      left join doc_sp_gsp c on a.dspid=c.dspid" +
			"                                                                                                                                      left join sp_pc_price e on a.dspid = e.dspid" +
			"                                                                                                                                      left join (" +
