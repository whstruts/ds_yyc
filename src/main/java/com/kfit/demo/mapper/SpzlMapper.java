...
public interface SpzlMapper {
	...
	@Select("select IFNULL(suppliers_name,'康信') as suppliers_name,ypdm,cddm,jx,scrq,txm,case when isnull(goods_id_s) then goods_sn else goods_id_s end as goods_id_s,goods_sn," +
